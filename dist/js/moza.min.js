/** Moza v1.0.0, by Jerome D.Soucy.
 | https://github.com/jeromeds/Moza.git | Licensed under MIT */
;t[o][0].call(l.exports,function(e){return s(n?n:e)},XL:{maxAmount:2,col: 4,row: 4},L:{maxAmount:10,col: 3,row: 2},M:{maxAmount:10,col: 2,row: 2},S:{maxAmount:10,col: 2,row: 1},XS:{maxAmount:50,col: 1,row: 1}; Grid.prototype.buildGrid = function (params){//todo:this should be more specific. it will help understand the code when we call this from a sub function. this.row = row;//todo:find a more specific name for this. its more a zone or area then tile this.tileHeight = this.gridHeight/row}module.exports ={getJSON:getJSON},[2])
